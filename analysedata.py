...
def calculate_complexity_scores(df: pd.DataFrame, verbose: bool = True, tophard: bool = False) -> pd.DataFrame:
    """
    ...
    if tophard:
        ...
        print(
            fre_top[["Original", "Original FRE Score", "Leichte Sprache", "Leichte Sprache FRE Score"]].to_markdown()
        )
        ...
        print(
            wstf_top[
                ["Original", "Original WSTF Score", "Leichte Sprache", "Leichte Sprache WSTF Score"]
            ].to_markdown()
        )
...
def main(
    ...
    if save_file:
        ...
        print(f"Saved analysed dataset to {output_filename}")
